...
class TestRegistration:
    ...
    result_email, status_email = RegistrationEmail().get_api_email()  # запрос на получение временного e-mail
    email_reg = result_email[0]  # получаем временный e-mail
    ...
    def test_get_registration_valid(self, browser):
        ...
        """Проверяем вариант регистрации при использовании e-mail и получения кода для входа на почту.
         Используем временный e-mail и получаем данные через GET запросы."""
        ...
        """Переходим на страницу ввода данных для прохождения регистрации на сайте"""
        ...
        # Нажимаем на кнопку 'Зарегистрироваться':
        page.btn_click()
        time.sleep(80)  # подождём, пока на почту придёт письмо...

        """Проверяем почтовый ящик и берем ID последнего письма"""
